...
public class Drug {
    ...
    public Drug(JSONObject jsonObject){
        ...
        cytotoxicityEff = getEfficacyFromJSON(jsonObject, "virusRemovalEff", "EC50", "n", "maxEfficacy");
        virusProductionReductionEff = getEfficacyFromJSON(jsonObject, "virusRemovalEff", "EC50", "n", "maxEfficacy");
        infectionReductionEff = getEfficacyFromJSON(jsonObject, "virusRemovalEff", "EC50", "n", "maxEfficacy");
    }
    ...
    public Efficacy getEfficacyFromJSON(JSONObject jsonObject, String key, String ec50, String n, String maxEfficacy) {
        if (jsonObject.containsKey(key)) {
            ...
            return new Hill((double) efficacyData.get(ec50), (int) efficacyData.get(n), (double) efficacyData.get(maxEfficacy));
        } else {
            return new NoEffect();
        }
    }
